...
public class TestCreateSignature
{
    ...
    public void testPdfBox4784() throws Exception {
    	...
    	byte[] fixedRandomSignedOne = signEncrypted(new FixedSecureRandom(new byte[128]), signingTime);
    	byte[] fixedRandomSignedTwo = signEncrypted(new FixedSecureRandom(new byte[128]), signingTime);
