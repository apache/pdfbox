...
public class CRLVerifierTest
{
     ...
     */
    @Test
    public void testLDAP() throws IOException, CertificateVerificationException, NamingException, URISyntaxException, GeneralSecurityException
    {
        ...
        InputStream is = SigUtils.openURL("http://www.ca.gov.si/crt/si-trust-root.crt");
