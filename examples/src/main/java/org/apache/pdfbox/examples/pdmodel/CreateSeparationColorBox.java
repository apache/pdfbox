...
public class CreateSeparationColorBox
{
    ...
    public static void main(final String[] args) throws IOException
    {
        try (PDDocument doc = new PDDocument())
        {
            ...
            final COSArray separationArray = new COSArray();
            ...
            final PDColorSpace spotColorSpace = new PDSeparation(separationArray);
            
            try (PDPageContentStream cs = new PDPageContentStream(doc, page))
            {
                final PDColor color = new PDColor(new float[]{0.5f}, spotColorSpace);
