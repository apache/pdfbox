            ...
            throws CertificateVerificationException, RevokedCertificateException
    {
        try
        {
            ...
            for (final String crlDistributionPointsURL : crlDistributionPointsURLs)
            {
                ...
                catch (final IOException | GeneralSecurityException | CertificateVerificationException | NamingException ex)
                {
        ...
        catch (final RevokedCertificateException | CertificateVerificationException ex)
        {
            throw ex;
        }
