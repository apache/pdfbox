...
class PDDeviceNTest
{
    ...
    private static COSDictionary linearFunction(float[] c0, float[] c1)
    {
        ...
        function.setItem(COSName.DOMAIN, COSArray.of(0, 1));
        function.setItem(COSName.C0, COSArray.of(c0));
        function.setItem(COSName.C1, COSArray.of(c1));
            ...
            float[] cmykAtOne) throws IOException
    {
        ...
        deviceN.add(COSArray.ofCOSNames(List.of(COLORANT)));
     ...
     */
    @Test
    void testSpotColorantNotWhiteAtZeroTint() throws IOException
    {
        ...
        {
            assertTrue(component > 0.9f, "no ink must be white, but was " + component);
        }
        ...
        assertTrue(tint[0] > 0.3f, "expected a light color, but red was " + tint[0]);
    }
     ...
     */
    @Test
    void testSpotColorantNotWhiteAtZeroTintImage() throws IOException
    {
        PDDeviceN deviceN = createDeviceN(new float[] { 0, 0, 0 }, new float[] { 0, 0.41f, 0.31f },
                new float[] { 1, 0.09f, 0.66f, 0.41f });
     ...
     */
    @Test
    void testSpotColorantWhiteAtZeroTint() throws IOException
    {
     ...
     */
    @Test
    void testZeroTintCheckDoesNotAffectNearZeroTints() throws IOException
    {
