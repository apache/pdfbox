...
class AppearanceGenerationTest
{
    ...
    // Test incomplete as the content stream differs
    @Test
    void rectangleFullStrokeNoFill() throws IOException
    {
        ...
        checkAnnotationTokens(annotations.get(0));
        checkAnnotationTokens(annotations.get(2));
        checkAnnotationTokens(annotations.get(4));
        checkAnnotationTokens(annotations.get(6));
        checkAnnotationTokens(annotations.get(8));
        checkAnnotationTokens(annotations.get(10));
        checkAnnotationTokens(annotations.get(12));
        checkAnnotationTokens(annotations.get(18));
        checkAnnotationTokens(annotations.get(20));
        checkAnnotationTokens(annotations.get(24));
        checkAnnotationTokens(annotations.get(26));
        checkAnnotationTokens(annotations.get(28));
        checkAnnotationTokens(annotations.get(30));
        checkAnnotationTokens(annotations.get(32));
        checkAnnotationTokens(annotations.get(34));
    ...
    private void checkAnnotationTokens(PDAnnotation annotation) throws IOException
    {
