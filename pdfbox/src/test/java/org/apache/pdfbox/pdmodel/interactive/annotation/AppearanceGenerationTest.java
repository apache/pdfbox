...
class AppearanceGenerationTest
{
    ...
    void rectangleFullStrokeNoFill() throws IOException
    {
        ...
        final PDAnnotation annotation = page.getAnnotations().get(0);
        ...
        final List<Object> tokensForOriginal = streamParser.parse();
        ...
        final List<Object> tokensForPdfbox = streamParser.parse();
        
        assertEquals(tokensForOriginal.size(), tokensForPdfbox.size(),
                "The number of tokens in the content stream should be the same");
        
        int actualToken = 0;
        for (final Object tokenForOriginal : tokensForOriginal)
        {
            final Object tokenForPdfbox = tokensForPdfbox.get(actualToken);
        ...
        final File file = new File(OUT_DIR, NAME_OF_PDF + "-newAP.pdf");
        document.save(file);
    }
