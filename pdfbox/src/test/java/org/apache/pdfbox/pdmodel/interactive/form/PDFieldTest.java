...
public class PDFieldTest
{
     ...
     */
    // @Test
    public void testSetPartialNameNull()
    {
        ...
        try {
            textField.setPartialName(null);
        } catch (Exception e) {
            // Expected behavior if null throws exception
        }
    }
    ...
    public void testPartialNameWithPeriodThrows()
    {
     ...
     */
    @Test
    public void testFullyQualifiedNameNullPartialName()
    {
     ...
     */
    @Test
    public void testFullyQualifiedNameWithParent()
    {
     ...
     */
    @Test
    public void testMultipleFlagsIndependently()
    {
        textField.setReadOnly(true);
        textField.setRequired(true);
        textField.setNoExport(false);
     ...
     */
    @Test
    public void testSetFieldFlagsZeroAndClearing()
    {
     ...
     */
    @Test
    public void testGetActionsNonNull()
    {
     ...
     */
    @Test
    public void testMultiplePropertiesTogether()
    {
