...
public class FDFField implements COSObjectable
{
    ...
    /**
     * This will get the value for the field. This will return type will either be: <ul>
     * <li>String : Checkboxes, Radio Button, Textfields</li>
     * <li>List&lt;String&gt; : Choice Field</li>
     * </ul>>
    ...
    /**
     * You should pass in a String, or a List&lt;String&gt; to set the value.
     *
    ...
    {
        Integer retval = null;
        COSNumber f = (COSNumber) field.getDictionaryObject("F");  // ToDo CosName.F  ?
        if (f != null)
        {
            retval = f.intValue();
        }
     ...
     *
     * @return The 'AA' entry in this field dictionary or null.
     */
