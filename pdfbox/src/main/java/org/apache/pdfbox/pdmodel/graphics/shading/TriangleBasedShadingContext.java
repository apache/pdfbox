...
//                        }
//                        map.put(new Point(x, y), evalFunctionAndConvertToRGB(cres));
//                    }
//                }                
...
//                if (degree == 3)
//                {
//                    // "fatten" triangle by drawing the borders with 
//                    // Bresenham's line algorithm
//                    // Inspiration: Raph Levien
...
//                    {
//                        map.put(p, convertToRGB(l1.calcColor(p)));
//                    }
//                    for (Point p : l2.linePoints)
//                    {
//                        map.put(p, convertToRGB(l2.calcColor(p)));
//                    }
//                    for (Point p : l3.linePoints)
//                    {
//                        map.put(p, convertToRGB(l3.calcColor(p)));
//                    }                    
//                }
            }
        }
