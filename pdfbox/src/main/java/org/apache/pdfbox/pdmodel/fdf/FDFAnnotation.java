...
public abstract class FDFAnnotation implements COSObjectable
{
    ...
    protected float[] parseRectangleAttributes(String rect, String errorMessage) throws IOException {
    ...
    protected PDRectangle createRectangleFromAttributes(String rect, String errorMessage) throws IOException {
        String[] rectValues = rect.split(",");
        if (rectValues.length != 4)
        {
            throw new IOException(errorMessage);
