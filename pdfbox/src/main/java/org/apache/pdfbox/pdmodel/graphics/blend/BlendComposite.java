...
public final class BlendComposite implements Composite
{
    ...
    class BlendCompositeContext implements CompositeContext
    {
        ...
        BlendCompositeContext(final ColorModel srcColorModel, final ColorModel dstColorModel,
                              final RenderingHints hints)
        {
        ...
        public void compose(final Raster src, final Raster dstIn, final WritableRaster dstOut)
        {
            ...
            final boolean subtractive = (dstColorSpaceType != ColorSpace.TYPE_RGB)
                    && (dstColorSpaceType != ColorSpace.TYPE_GRAY);

            final boolean blendModeIsSeparable = blendMode instanceof SeparableBlendMode;
            final SeparableBlendMode separableBlendMode = blendModeIsSeparable ?
                    (SeparableBlendMode) blendMode : null;
            final NonSeparableBlendMode nonSeparableBlendMode = !blendModeIsSeparable ?
