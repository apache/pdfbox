...
public class ObjectStreamXReference extends AbstractXReference {
	...
	/**
	 * Returns the value for the third column of the crossreference stream entry. (This is index of the {@link COSObject}
	 * in the containing object stream - for entries of this type.)
	 *
