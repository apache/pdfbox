...
public class GlyphLayoutBidiTest extends TestBase
{
    ...
    void testGlyphLayoutBidi() throws IOException, URISyntaxException
    {
        ...
        {
            PDType0Font arabicFont = createPdType0Font(glyphLayoutProcessorFop, doc, arabicPath);
            PDType0Font lgcFont = createPdType0Font(glyphLayoutProcessorFop, doc, lgcPath);
