...
class CharStringCommandTest
{
    ...
    void testKey()
    {
        ...
        final int[] value1 = key1.getValue();
        ...
        final Key key12_0 = new Key(12, 0);
        final int[] value12_0 = key12_0.getValue();
        ...
        final int[] keyValues12_3 = new int[] { 12, 3 };
        final Key key12_3 = new Key(keyValues12_3);
        final int[] value12_3 = key12_3.getValue();
    ...
    {
        final CharStringCommand charStringCommand1 = new CharStringCommand(1);
        ...
        final CharStringCommand charStringCommand12_0 = new CharStringCommand(12, 0);
        ...
        final int[] values12_3 = new int[] { 12, 3 };
        final CharStringCommand charStringCommand12_3 = new CharStringCommand(values12_3);
    ...
    {
        final CharStringCommand charStringCommandUnknown = new CharStringCommand(99);
