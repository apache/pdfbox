...
public class GlyphSubstitutionDataExtractor
{
    ...
    /**
     * Unlike {@link #getGsubData(Map, FeatureListTable, LookupListTable)}, this method doesn't
     * iterate over supported {@link Language}'s searching for the first match with the scripts
     * of the font. Instead, it unconditionally creates {@link ScriptTableDetails} instance with
     * language left {@linkplain Language#UNSPECIFIED unspecified}.
