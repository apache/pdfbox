...
public class CmapSubtable implements CmapLookup {
    ...
    void processSubtype14(TTFDataStream data, int numGlyphs) throws IOException {
        ...
        // see
        // http://blogs.adobe.com/CCJKType/2013/05/opentype-cmap-table-ramblings.html
    ...
    void processSubtype4(TTFDataStream data, int numGlyphs) throws IOException {
         ...
         * array that contains MAX(GlyphIds)
         * element, or -1
         */
    ...
    /**
     * Returns all possible character codes for the given gid, or null if there is
     * none.
     *
     * @param gid glyph id
