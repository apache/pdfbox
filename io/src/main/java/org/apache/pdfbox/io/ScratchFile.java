...
public class ScratchFile implements RandomAccessStreamCache
{
    ...
    private void handleScratchFile() throws IOException {
        ...
        if ( raf == null )
        {
            createAndInitializeScratchFile();
        }
        ...
        enlargeFileIfPossible(fileLen);
    }

    private void createAndInitializeScratchFile() throws IOException {
    ...
    private void enlargeFileIfPossible(long fileLen) throws IOException {
