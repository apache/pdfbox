...
class TestCOSFloat extends TestCOSNumber
{
    ...
    abstract class BaseTester
    {
        ...
        private void loop(long seed)
        {
            ...
            Random rnd = new Random( currentDate.getTime() );
    ...
    class AcceptTester extends BaseTester
    {
        ...
        final TestVisitor visitor = new TestVisitor(outStream);   // writing gets tested elsewhere
        ...
        void runTest(float num)
        {
            ...
            String expected = "COSFloat{" + floatToString( cosFloat.floatValue() ) + "}";
            assertEquals(expected, outStream.toString( StandardCharsets.ISO_8859_1 ));
            testByteArrays(expected.getBytes(StandardCharsets.ISO_8859_1), outStream.toByteArray());
            outStream.reset();
        }
...
//            {
//                COSFloat cosFloat = new COSFloat(num);
//                // cosFloat.writePDF(outStream); // writing gets tested elsewhere
//
...
//    }
     ...
     */
//    @Test
//    void testWritePDF()     // writing gets tested elsewhere
//    {
