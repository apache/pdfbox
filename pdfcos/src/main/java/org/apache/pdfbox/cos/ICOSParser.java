...
/**
 * Presumably this is a parser interface which requires that implementing classes
 * be able to dereference (read/decode) indirect (Proxy) objects. Note that this
 * is just an interface declaration. The actual parser implementations will be
 * in the pdfparser package.
 */
public interface ICOSParser
{
    ...
    /**
     * Creates {@link RandomAccessReadView} object for unknown reasons starting at the given position with the given length.
     *
