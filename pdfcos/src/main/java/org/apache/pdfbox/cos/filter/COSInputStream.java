...
{
    public static COSInputStream create( COSStream cosStreamObject ) throws IOException
    {
        return create( cosStreamObject.getFilterList(), cosStreamObject, cosStreamObject.createRawInputStream());
    }
     ...
     */
    public static COSInputStream create(List<Filter> filters, COSDictionary parameters, InputStream in)
            throws IOException
    {
