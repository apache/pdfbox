...
/**
 * The "PDFDocEncoding" encoding. PDFDocEncoding is a predefined text encoding
 * unique to PDF. It supports a superset of the ISO Latin 1 character set which
 * happens, as Adobe’s PDF Reference 1.2 puts it, to be “compatible with Unicode
 * in that all Unicode codes less than 256 match PDFDocEncoding.”  Note that
 * this is *not* a Type 1 font encoding, it is used only within PDF "text strings".
 */
