...
public abstract class Filter
{
    ...
    {
        COSBase filter = dictionary.getAlternateObjectFromDictionary( COSName.F, COSName.FILTER );
        COSBase obj = dictionary.getAlternateObjectFromDictionary( COSName.DP, COSName.DECODE_PARMS );
