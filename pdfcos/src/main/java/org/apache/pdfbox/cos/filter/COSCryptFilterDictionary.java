 ...
 * document It contains a low level dictionary (COSDictionary) and provides
 * methods to manage its fields.
 */
public class COSCryptFilterDictionary implements COSObjectGetter
{
     ...
     */
    public COSCryptFilterDictionary()
    {
     ...
     */
    public COSCryptFilterDictionary( COSDictionary d)
    {
    ...
    {
        COSBase value = cryptFilterDictionary.getObjectFromDictionary( COSName.ENCRYPT_META_DATA );
