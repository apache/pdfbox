...
public class COSDictionaryMap<K,V> implements Map<K,V>
{
    ...
    {
        COSObjectGetter object = (COSObjectGetter)value;
    ...
    /**
     * This will take a map&lt;java.lang.String,org.apache.pdfbox.pdmodel.COSObjectGetter&gt;
     * and convert it into a COSDictionary.
     *
     * @param someMap A map containing COSObjectGetters
     *
    ...
    public static COSDictionary convert(Map<String, ?> someMap)
    {
        ...
        {
            COSObjectGetter object = (COSObjectGetter) objectable;
    ...
    public static COSDictionaryMap<String, Object> convertBasicTypesToMap( COSDictionary map ) throws IOException
    {
        ...
        if( map != null )
        {
            ...
            {
                COSBase cosObj = map.getObjectFromDictionary( key );
