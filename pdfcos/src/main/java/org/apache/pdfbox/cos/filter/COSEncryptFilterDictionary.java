...
import org.apache.pdfbox.cos.COSObjectGetter;

/**
 * This class is a specialized view of the encryption filter dictionary of a
 * PDF document. It contains a low level dictionary (COSDictionary) and provides
 * the methods to manage its fields.
 */
public class COSEncryptFilterDictionary implements COSObjectGetter
{
    /**
     ...
     */
    public COSEncryptFilterDictionary()
    {
     ...
     */
    public COSEncryptFilterDictionary( COSDictionary d)
    {
    ...
    {
        COSBase value = getCOSObject().getObjectFromDictionary( COSName.ENCRYPT_META_DATA);
