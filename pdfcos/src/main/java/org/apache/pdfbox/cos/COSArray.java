...
public class COSArray extends COSBase implements Iterable<COSBase>, COSUpdateInfo
{
     ...
     * 
     * @param COSObjectGetters the initial list of COSObjectGetters
     */
    public COSArray(List<? extends COSObjectGetter> COSObjectGetters)
    {
        this(
            COSObjectGetters.stream()
     ...
     * @param object The object to add to the array.
     */
    public void add( COSObjectGetter object )
    {
        COSBase base = null;
        if (object != null)
        {
     ...
     * @param object The object to set.
     */
    public void set( int index, COSObjectGetter object )
    {
        COSBase base = null;
        if( object != null )
        {
