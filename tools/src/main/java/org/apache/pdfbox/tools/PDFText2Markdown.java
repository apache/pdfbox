 ...
 * Each line in the PDF is converted to a corresponding Markdown paragraph.
 * Bold and italic formatting is also applied based on font properties.
 *
 * @author Saurav Rawat
 */
public class PDFText2Markdown extends PDFTextStripper {
    ...
    /**
     * Write out the article separator with proper text direction
     * information.
     *
    ...
    private static class FontState {
         ...
         *
         * @return A string that contains the closing tags of all currently open Markdown formatting.
         */
        public String clear() {
            StringBuilder buffer = new StringBuilder();
