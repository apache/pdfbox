...
public class TestFields extends TestCase
{
    ...
    private static final String PATH_OF_PDF = "src/test/resources/org/apache/pdfbox_ai2/pdmodel/interactive/form/AcroFormsBasicFields.pdf";
    ...
    public void testAcroFormsBasicFields() throws IOException
    {
        ...
        try
        {
            ...
            assertEquals(textField.getCOSObject().getDictionaryObject(
                    ...
                    "org.apache.pdfbox_ai2.cos.COSStream");
