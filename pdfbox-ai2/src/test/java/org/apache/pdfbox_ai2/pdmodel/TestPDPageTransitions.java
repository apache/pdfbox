...
import org.apache.pdfbox_ai2.pdmodel.interactive.pagenavigation.PDTransition;
import org.apache.pdfbox_ai2.pdmodel.interactive.pagenavigation.PDTransitionDirection;
import org.apache.pdfbox_ai2.pdmodel.interactive.pagenavigation.PDTransitionStyle;
...
public class TestPDPageTransitions
{
    ...
    public void readTransitions() throws IOException
    {
        PDDocument doc = PDDocument.load(this.getClass().getResourceAsStream(
                "/org/apache/pdfbox_ai2/pdmodel/interactive/pagenavigation/transitions_test.pdf"));
